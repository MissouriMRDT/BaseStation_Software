...
import fs from 'fs';
import { rovecam } from '../RoveCam/RoveCam';
...
class Cameras extends Component<IProps, IState> {
  ...
  rotate(): void {
    ...
    const X_FACTOR = height / width;
    const Y_FACTOR = width / height;
    ...
    if (rotation === 90 || rotation === 270) {
      transform += `scaleX(${X_FACTOR}) scaleY(${Y_FACTOR})`;
    }
        ...
        <div style={container}>
          <div style={column}>
            ...
            {/* <img
              ...
              id={this.state.id}
            /> */}
            <video id="camvid" autoPlay srcObject={this.state.remote} width={300} height={300} />
            <div style={row}>
            ...
            <div style={row}>
              ...
              <button
                type="button"
                onClick={() => {
                  // document.getElementById('camvid')!.srcObject = rovecam.remote;
                  // document.getElementById('camvid')!.play();
                  console.log('hi');
                  console.log(rovecam.remote);
                  this.setState({ remote: rovecam.remote });
                }}
                style={{ width: '50%' }}
              >
                Refresh
